...
public class SteamManager : MonoBehaviour
{
    ...
    private const string isFriendLobby = "friendLobby";
    private const string isRankedDataString = "rankedLobby";

    private const string ownerNameDataString = "ownerNameData";

    private const string playerEloDataString = "playerEloData";

    private const string staticDataString = "staticData";
    ...
    public void RelaySocketMessageReceived(IntPtr data, int size, uint connectionId){

    }

    public void ProcessMessageFromSocketServer(IntPtr data, int size){
    ...
    public async Task<bool> CreateLobby(string lobbyParameters)
    {
        try
        {
            var createLobbyOutput = await SteamMatchmaking.CreateLobbyAsync(2);
