...
namespace HeathenEngineering.SteamworksIntegration.API
{
    ...
    public static class Parties
    {
        public static class Client
        {
            ...
            public static ReservationNotificationCallbackEvent EventReservationNotificationCallback
            {
                get
                {
                    if (m_ReservationNotificationCallback_t == null)
                        m_ReservationNotificationCallback_t = Callback<ReservationNotificationCallback_t>.Create(eventReservationNotificationCallback.Invoke);
            ...
            /// </summary>
            public static ActiveBeaconsUpdatedEvent EventActiveBeaconsUpdatedEvent
            {
                get
                {
            ...
            /// </summary>
            public static AvailableBeaconLocationsUpdatedEvent EventAvailableBeaconLocationsUpdatedEvent
            {
                get
                {
            ...
            public static void CreateBeacon(uint openSlots, ref SteamPartyBeaconLocation_t location, string connectionString, string metadata, Action<CreateBeaconCallback_t, bool> callback)
            {
                ...
                m_CreateBeaconCallback_t.Set(handle, callback.Invoke);
            }
            /// <summary>
            ...
            public static void OnReservationCompleted(PartyBeaconID_t beacon, CSteamID user) => SteamParties.OnReservationCompleted(beacon, user);
            /// <summary>
            ...
            /// <param name="beacon"></param>
            /// <returns></returns>
            public static bool DestroyBeacon(PartyBeaconID_t beacon) => SteamParties.DestroyBeacon(beacon);
            /// <summary>
