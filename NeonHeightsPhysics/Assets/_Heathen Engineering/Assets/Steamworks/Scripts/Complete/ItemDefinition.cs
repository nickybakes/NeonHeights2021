...
namespace HeathenEngineering.SteamworksIntegration
{
    ...
    {
        public SteamItemDef_t Id => new SteamItemDef_t(item_itemdefid);
        ...
        public class ExchangeRecipe
        {
            ...
            {
                [Serializable]
                public class Item_Def_Descriptor
                {
                    public ItemDefinition item;
                    public uint count;
                ...
                [Serializable]
                public class Item_Tag_Descriptor
                {
                    public string name;
                    public string value;
                    public uint count;
            ...
            public bool Valid => !materials.Any(p => !p.Valid);
        ...
        public Enums.InventoryItemType item_type;
        ...
        public List<ItemDefinition> item_tag_generators = new List<ItemDefinition>();
