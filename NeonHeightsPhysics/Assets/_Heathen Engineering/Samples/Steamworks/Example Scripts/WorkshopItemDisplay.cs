...
namespace HeathenEngineering.EXAMPLES
{
    public class WorkshopItemDisplay : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        [HideInInspector]
        ...
        public void RegisterData(UGCCommunityItem data)
        {
            loading = true;
            Data = data;
